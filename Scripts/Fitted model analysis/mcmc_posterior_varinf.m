...
params_best = get_params_varinf(theta_mat(posn_best,:),k_inc,gamma,k_I);
...
% Save results
save('../../Results/mcmc_posterior_varinf','ll_best','params_best','prob_presymp_best','prob_presymp_post')
